...
import BlogManager from '@/components/BlogManagerComplete';
...
const AdminPage = () => {
  ...
  const updatePaymentStatus = async (orderId: string, newPaymentStatus: string) => {
    try {
      ...
      toast({
        title: "Fehler beim Aktualisieren des Zahlungsstatus",
        description: error.message,
        variant: "destructive",
      });
    }
  ...
  const generateDeliveryNote = async (order: Order) => {
    try {
      ...
      if (itemsError) {
        throw new Error('Fehler beim Laden der Bestellartikel');
      }
                          ...
                          <div className="space-y-2">
                            ...
                            >
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value="completed">Bezahlt</SelectItem>
